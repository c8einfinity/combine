...
def get_total_transcribed_stats():
    ...
    processed_queue = queue.__dba__.fetch_one("select count(*) as processed_count from player_transcripts where verified_user_id > 0")
...
def get_player_transcribed_stats(player_id):
    ...
    processed_queue = queue.__dba__.fetch_one("select count(*) as processed_count from player_transcripts where player_id = ? and verified_user_id > 0", [player_id])
